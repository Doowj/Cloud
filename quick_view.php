...
include $_SERVER['DOCUMENT_ROOT'] . '/components/_base.php';
include $_SERVER['DOCUMENT_ROOT'] . '/components/add_cart.php';
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/components/user_header.php'; ?>
  ...
  <?php endif; ?>
    ...
    <div class="review-filters">
        ...
        <?php if (isset($_user->id)): ?>
            <a href="/?product_id=<?= htmlspecialchars($product_id); ?>&rating=<?= htmlspecialchars($rating_filter); ?>&my_reviews=<?= ($show_my_reviews === 'yes') ? 'no' : 'yes' ?>" 
