...
<header class="header">
   ...
   <section class="flex">
      ...
      <nav class="navbar">
         ...
         <a href="/admin/admin_member_accounts.php">Member</a>
         <a href="/admin/admin-chat.php">Real-Time-Chat</a>
         <div class="dropdown">
            <a class="dropbtn"  href="/admin/sales_report.php">Reports</a>
            <div class="dropdown-content">
               <a href="/admin/sales_report.php">Sales Report</a>
               <a href="/admin/top10_products.php">Top 10 Products Report</a>
