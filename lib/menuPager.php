...
class SimplePager {
    ...
    public function html($href = '', $attr = '') {
        ...
        echo "<a href='$base_url?page=1&$href'>First</a>";
        echo "<a href='$base_url?page=$prev&$href'>Previous</a>";

        for ($p = 1; $p <= $this->page_count; $p++) {
            $c = $p == $this->page ? 'active' : '';
            echo "<a href='$base_url?page=$p&$href' class='$c'>$p</a>";
        }

        echo "<a href='$base_url?page=$next&$href'>Next</a>";
        echo "<a href='$base_url?page=$this->page_count&$href'>Last</a>";
        echo "</nav>";
    }
}
