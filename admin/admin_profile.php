...
include __DIR__ . '/../components/_base.php';
...
<?php include __DIR__ . '/../components/admin_header.php'; ?>
    ...
    <section class="profile-container">
        <div class="profile-card">
            ...
            <a href="/admin/admin_update_profile.php" class="edit-button">Edit Profile</a>
            <a href="/admin/admin_reset_password.php" class="edit-button" style="background-color: green;">Reset Password</a>
        </div>
    </section>
</body>
