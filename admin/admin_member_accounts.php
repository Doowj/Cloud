<?php
require __DIR__ . '/../components/_base.php'; // Include base file for DB connection and other utilities
...
<body>
   <?php include __DIR__ . '/../components/admin_header.php'; ?> <!-- Include Admin Header -->
...
<section>
   ...
   <!-- Add Member button -->
   <button class="add-member-btn" onclick="window.location.href='/admin/admin_member_add.php'" style="background-color: green; color: white; padding: 8px 16px; border: none; cursor: pointer;">Add Member</button>
   </div>
         ...
         <?php if ($members): ?>
            <?php foreach ($members as $member): ?>
               <tr>
                  ...
                  <td>
                  <button onclick="window.location.href='/admin/admin_member_edit.php?id=<?= encode($member->id) ?>'">Edit</button> 
                  <form action="/admin/admin_member_delete.php" method="POST" style="display:inline;">
                  ...
                  <form action="/admin/admin_member_toggle_status.php" method="POST" style="display:inline;">
                  <?= html_hidden2("id","",encode($member->id))?>
                  <?php
                     $items = [
                        'active' => 'Active',
